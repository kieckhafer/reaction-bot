...
controller.hears(["#timezones", "#currentTime"], "direct_message,direct_mention,mention,message_received,ambient", function (bot, message) {
  ...
  var americaMountain = baseTime.clone().tz("America/Denver").format("hh:mm A") + ":  :flag-us-co:  Colorado Springs (Spencer) / :flag-us-ut:  Park City (Cassy) / :flag-us-ut:  Park City (Cassy) / :flag-us-az:  Phoenix (Vishal)";
